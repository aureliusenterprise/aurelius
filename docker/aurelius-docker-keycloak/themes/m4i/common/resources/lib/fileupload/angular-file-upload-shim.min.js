...
!(function () {
    if (
        (window.XMLHttpRequest &&
            (XMLHttpRequest = window.FormData
                ? (function (a) {
                      return function () {
                          var b = new a();
                          return (
                ...
                : (function (a) {
                      return function () {
                          ...
                          return (
                              ...
                              (b.send = function () {
                                  if (null != arguments[0] && arguments[0].__isShim && arguments[0].__setXHR_) {
                                      var a = arguments[0];
                                      ...
                                      var d = {
                                          ...
                                          complete: function (a, c) {
                                              (Object.defineProperty(b, 'status', {
                                                  ...
                                                  Object.defineProperty(b, 'statusText', {
                                                      get: function () {
                                                          return c.statusText;
                                                      },
                                                  }),
        ...
        var d = function (b) {
                if (
                    !b.__isWrapped &&
                    (null != b.getAttribute('ng-file-select') || null != b.getAttribute('data-ng-file-select'))
                ) {
                    var c = document.createElement('div');
                    ((c.innerHTML =
                        '<div class="js-fileapi-wrapper" style="position:relative; overflow:hidden"></div>'),
                        (c = c.firstChild));
                    var d = b.parentNode;
                    (d.insertBefore(c, b),
                        d.removeChild(b),
                        c.appendChild(b),
                        a || c.appendChild(document.createTextNode('Flash is required')),
                        (b.__isWrapped = !0));
                }
            },
            e = function (a) {
                return function (b) {
                    ...
                    (b.target || (b.target = {}),
                        (b.target.files = c),
                        (b.target.files.item = function (a) {
            ...
            f = function (a, b) {
                return (
                    ('change' === b.toLowerCase() || 'onchange' === b.toLowerCase()) && 'file' == a.getAttribute('type')
                );
            };
        (HTMLInputElement.prototype.addEventListener &&
            (HTMLInputElement.prototype.addEventListener = (function (a) {
                return function (b, c, g, h) {
                    f(this, b) ? (d(this), a.apply(this, [b, e(c), g, h])) : a.apply(this, [b, c, g, h]);
                };
            })(HTMLInputElement.prototype.addEventListener)),
            HTMLInputElement.prototype.attachEvent &&
                (HTMLInputElement.prototype.attachEvent = (function (a) {
                    return function (b, c) {
                ...
                if (!window.FileAPI || !FileAPI.upload) {
                    ...
                    if (window.FileAPI && window.FileAPI.jsPath) d = window.FileAPI.jsPath;
                        ...
                        for (a = 0; a < f.length; a++)
                            if (
                                ((c = f[a].src),
                                (b = c.indexOf('angular-file-upload-shim.js')),
                                -1 == b && (b = c.indexOf('angular-file-upload-shim.min.js')),
                                b > -1)
                            ) {
                                d = c.substring(0, b);
                                break;
                            }
                    ((window.FileAPI && null != FileAPI.staticPath) || (FileAPI = { staticPath: d }),
                        e.setAttribute('src', d + 'FileAPI.min.js'),
