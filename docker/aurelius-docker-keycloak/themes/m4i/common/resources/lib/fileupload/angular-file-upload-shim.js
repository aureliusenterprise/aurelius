...
(function () {
                            ...
                            var config = {
                                ...
                                complete: function (err, fileApiXHR) {
                                    ...
                                    Object.defineProperty(xhr, 'responseText', {
                                        get: function () {
                                            return fileApiXHR.responseText;
                                        },
                                    });
    ...
    if (!window.FormData) {
        ...
        var wrapFileApi = function (elem) {
            if (
                !elem.__isWrapped &&
                (elem.getAttribute('ng-file-select') != null || elem.getAttribute('data-ng-file-select') != null)
            ) {
        ...
        var isFileChange = function (elem, e) {
            return (
                (e.toLowerCase() === 'change' || e.toLowerCase() === 'onchange') && elem.getAttribute('type') == 'file'
            );
        };
