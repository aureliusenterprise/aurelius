((function () {
    ...
    ace.define('ace/lib/dom', ['require', 'exports', 'module'], function (e, t, n) {
        ...
        ((t.getDocumentHead = function (e) {
            ...
            (t.importCssString = function (n, r, i) {
                ...
                (r && (n += '\n/*# sourceURL=ace/css/' + r + ' */'),
                    i.createStyleSheet
                        ? ((s = i.createStyleSheet()), (s.cssText = n), r && (s.owningElement.id = r))
    ...
    ace.define('ace/lib/useragent', ['require', 'exports', 'module'], function (e, t, n) {
        ...
        ((t.isWin = r == 'win'),
            ...
            (t.isGecko = t.isMozilla =
                (window.Controllers || window.controllers) && window.navigator.product === 'Gecko'),
        ...
        function (e, t, n) {
            ...
            var u =
                !i.isMac || !i.isOpera || 'KeyboardEvent' in window
                    ...
                    : function (e) {
                          return (
                              0 | (e.metaKey ? 1 : 0) | (e.altKey ? 2 : 0) | (e.shiftKey ? 4 : 0) | (e.ctrlKey ? 8 : 0)
                          );
                      };
                    ...
                    if (i.isOldGecko || (i.isOpera && !('KeyboardEvent' in window))) {
                        ...
                        (r(e, 'keydown', function (e) {
                            ...
                            ((s[t] = (s[t] || 0) + 1),
                                t == 91 || t == 92
                                    ? (s.OSKey = !0)
                                    : s.OSKey && e.timeStamp - s.lastT > 200 && s.count == 1 && f(),
                                s[t] == 1 && s.count++,
                                (s.lastT = e.timeStamp));
                            var r = a(n, e, t);
    ...
    ace.define(
        ...
        ['require', 'exports', 'module', 'ace/lib/event', 'ace/lib/useragent', 'ace/lib/dom', 'ace/lib/lang'],
        function (e, t, n) {
            'use strict';
            var r = e('../lib/event'),
                i = e('../lib/useragent'),
                ...
                f = function (e, t) {
                    ...
                    var L = !1,
                        ...
                        H = function (e) {
                            var s = M(e);
                            typeof s == 'string'
                                ? (s && t.onPaste(s, e), i.isIE && setTimeout(b), r.preventDefault(e))
                                : ((n.value = ''), (c = !0));
                        };
            ...
            function f(e) {
                ...
                function L() {
                    (clearInterval(v),
                        ...
                        (t.$blockScrolling -= 1),
                        t.isFocused() && !w && t.renderer.$cursorLayer.setBlinking(!t.getReadOnly()),
                        (m = null),
                        (g = null),
                        (y = 0),
                        (E = null),
    ...
    ace.define(
        'ace/config',
        ['require', 'exports', 'module', 'ace/lib/lang', 'ace/lib/oop', 'ace/lib/net', 'ace/lib/app_config'],
        function (e, t, n) {
            'no use strict';
            function f(r) {
            ...
            var r = e('../lib/event'),
                ...
                l = function (e) {
                    ...
                    (r.addListener(u, 'click', this.onMouseEvent.bind(this, 'click')),
                        r.addListener(u, 'mousemove', this.onMouseMove.bind(this, 'mousemove')),
                    ...
                    (r.addListener(f, 'mousedown', this.onMouseEvent.bind(this, 'guttermousedown')),
                        r.addListener(f, 'click', this.onMouseEvent.bind(this, 'gutterclick')),
                        r.addListener(f, 'dblclick', this.onMouseEvent.bind(this, 'gutterdblclick')),
                        r.addListener(f, 'mousemove', this.onMouseEvent.bind(this, 'guttermousemove')),
                ...
                ((this.setDefaultHandler = function (e) {
                    ...
                    (this.$callKeyboardHandlers = function (e, t, n, r) {
                        ...
                        return (
                            ...
                            o && this.$editor._signal('keyboardActivity', s),
                            o
                        );
                    }),
    ...
    ace.define(
        'ace/selection',
        ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/lib/event_emitter', 'ace/range'],
        function (e, t, n) {
            'use strict';
            var r = e('./lib/oop'),
                i = e('./lib/lang'),
                ...
                (this.getLineTokens = function (e, t) {
                    ...
                    while ((a = u.exec(e))) {
                        ...
                        if (c++ > i) {
                            ...
                            while (l < e.length)
                                (h.type && f.push(h), (h = { value: e.substring(l, (l += 2e3)), type: 'overflow' }));
                            ((r = 'start'), (n = []));
                            break;
                        }
                    }
                ...
                function i(s) {
                    ...
                    for (var u = 0; u < o.length; u++) {
                        ...
                        if (f && Array.isArray(f)) {
                            var l = a.stateName;
                            (l || ((l = a.token), typeof l != 'string' && (l = l[0] || ''), r[l] && (l += n++)),
                                (r[l] = f),
                                (a.next = l),
                                i(l));
                        } else f == 'pop' && (a.next = t);
        ...
        function (e, t, n) {
            ...
            ((function () {
                ((this.tokenRe = new RegExp(
                    '^[' + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + '\\$_]+',
                    'g',
                )),
                ...
                ((this.getFoldAt = function (e, t, n) {
                    ...
                    (this.addFold = function (e, t) {
                        var n = this.$foldData,
                            r = !1,
                            o;
                        (e instanceof s ? (o = e) : ((o = new s(t, e)), (o.collapseChildren = t.collapseChildren)),
                ...
                (r.implement(this, o),
                    ...
                    (this.onChange = function (e) {
                        ...
                        (!this.$fromUndo &&
                            ...
                            t && t.length != 0 && this.$deltasFold.push({ action: 'removeFolds', folds: t }),
                            ...
                            ((this.$syncInformUndoManager = function () {
                                (t.$informUndoManager.cancel(),
                                    t.$deltasFold.length &&
                                        ...
                                        (t.$deltasFold = [])),
                                    t.$deltasDoc.length &&
                                        (t.$deltas.push({ group: 'doc', deltas: t.$deltasDoc }), (t.$deltasDoc = [])),
                                    t.$deltas.length > 0 &&
                                        e.execute({
                                            action: 'aceupdate',
                                            args: [t.$deltas, t],
                            ...
                            ((i = e[a]),
                                r(i)
                                    ? ((o = i.start),
                                      ...
                                      (u = !0))
                                    : ((o = i.start),
                                      s.compare(o.row, o.column) == -1 && (s = f.fromPoints(i.start, i.start)),
                                      (u = !1)));
                        if (n != null) {
                    ...
                    (this.moveText = function (e, t, n) {
                        ...
                        if (!n) {
                            ...
                            (u &&
                                (s.start.row == e.end.row && s.start.column > e.end.column && (s.start.column += u),
                        ...
                        if (this.$useWrapMode) {
                            ...
                            if (m) {
                                ...
                                ((s = m[g]),
                                    g > 0 &&
                                        m.length &&
                                        ((v = m.indent), (i = m[g - 1] || m[m.length - 1]), (n = n.substring(i))));
                            }
                        }
                        return (
                        ...
                        (this._addCommandToBinding = function (t, n, r) {
                            ...
                            if (!n) delete i[t];
                                ...
                                (Array.isArray(i[t])
                                    ...
                                    : (i[t] = [i[t]]),
                                    typeof r != 'number' && (r || n.isDefault ? (r = -100) : (r = e(n))));
                                var o = i[t];
                ...
                },
                {
                    ...
                    exec: function (e) {
                        ...
                        (i.row + 1 < e.session.doc.getLength() - 1 && (f += e.session.doc.getNewLineCharacter()),
                            ...
                            a > 0
                                ? (e.selection.moveCursorTo(n.row, n.column), e.selection.selectTo(n.row, n.column + a))
                ...
                (r.implement(this, d),
                        ...
                        ((this.$highlightTagPending = !0),
                            setTimeout(function () {
                                ...
                                (t.$tagHighlight &&
                                    ...
                                    (t.removeMarker(t.$tagHighlight), (t.$tagHighlight = null)),
                                    l && !t.$tagHighlight && (t.$tagHighlight = t.addMarker(l, 'ace_bracket', 'text')));
                            }, 50));
                    }),
                    (this.focus = function () {
                        var e = this;
                    ...
                    (this.insert = function (e, t) {
                        ...
                        if (this.getBehavioursEnabled() && !t) {
                            ...
                            s &&
                                (e !== s.text && ((this.session.mergeUndoDeltas = !1), (this.$mergeNextCommand = !1)),
                                (e = s.text));
                        }
                    ...
                    (this.isRowFullyVisible = function (e) {
                        return (
                            e >= this.renderer.getFirstFullyVisibleRow() && e <= this.renderer.getLastFullyVisibleRow()
                        );
                    }),
                    ...
                    (this.jumpToMatching = function (e, t) {
                        ...
                        if (o === 'bracket') {
                            ...
                            s &&
                                ...
                                ((d = h.start), d.row == n.row && Math.abs(d.column - n.column) < 2 && (d = h.end));
                        }
                        ((d = (h && h.cursor) || d),
                            d &&
                                (e
            ...
            ((function () {
                (i.implement(this, o),
                    ...
                    (this.update = function (e) {
                        ...
                        for (;;) {
                            v > o &&
                                ((v = s.end.row + 1), (s = t.getNextFoldLine(v, s)), (o = s ? s.start.row : Infinity));
                            if (v > i) {
                            ...
                            if (y) {
                                p.foldWidget ||
                                    ((p.foldWidget = r.createElement('span')), p.element.appendChild(p.foldWidget));
                                var m = 'ace_fold-widget ace_' + y;
                                (y == 'start' && v == o && v < s.end.row ? (m += ' ace_closed') : (m += ' ace_open'),
                ...
                (r.implement(this, u),
                            ...
                            if (this.displayIndentGuides) {
                                ...
                                if (this.showInvisibles) {
                                    ...
                                    var u = s.stringRepeat(' ', this.tabSize),
                                        a = u;
                                ((this.$tabStrings[' '] = "<span class='" + r + i + "'>" + u + '</span>'),
                                    (this.$tabStrings['	'] = "<span class='" + r + o + "'>" + a + '</span>'));
                            }
                        }),
                        ...
                        for (;;) {
                            ...
                            if (l) {
                                ...
                                (this.$renderLine(c, u, !this.$useLineGroups(), u == f ? a : !1),
                                    (l.style.height = e.lineHeight * this.session.getRowLength(u) + 'px'),
                                    (l.innerHTML = c.join('')));
                            }
                            u++;
                        }
                        ...
                        for (;;) {
                            ...
                            if (this.$useLineGroups())
                                ((a.className = 'ace_line_group'),
                                    r.appendChild(a),
                                    (a.style.height = e.lineHeight * this.session.getRowLength(s) + 'px'));
                    ...
                    (this.$renderLine = function (e, t, n, r) {
                        ...
                        n ||
                            e.push(
                                "<div class='ace_line' style='height:",
                                this.config.lineHeight * (this.$useLineGroups() ? 1 : this.session.getRowLength(t)),
                                "px'>",
                            );
                        if (i.length) {
                ...
                ((this.CHANGE_CURSOR = 1),
                    ...
                    (this.onResize = function (e, t, n, r) {
                        ...
                        (e && (this.$gutterLayer.$padding = null),
                            e ? this.$renderChanges(s | this.$changes, !0) : this.$loop.schedule(s | this.$changes),
                    ...
                    (this.$autosize = function () {
                        var e = this.session.getScreenLength() * this.lineHeight,
                            ...
                            n =
                                Math.max((this.$minLines || 1) * this.lineHeight, Math.min(t, e)) +
                                this.scrollMargin.v +
                                (this.$extraHeight || 0);
                    ...
                    (this.$computeLayerConfig = function () {
                        ...
                        (this.session.setScrollTop(
                            Math.max(-h.top, Math.min(this.scrollTop, i - t.scrollerHeight + h.bottom)),
                        ),
                            this.session.setScrollLeft(
                                Math.max(
                                    -h.left,
                                    Math.min(this.scrollLeft, s + 2 * this.$padding - t.scrollerWidth + h.right),
                                ),
                            ));
                        var p =
                                !n &&
                    ...
                    (this.scrollCursorIntoView = function (e, t, n) {
                        ...
                        a + o > s
                            ...
                            : a + this.$size.scrollerHeight - u < s + this.lineHeight &&
                              ...
                              this.session.setScrollTop(s + this.lineHeight - this.$size.scrollerHeight));
                        var f = this.scrollLeft;
                        f > i
                            ? (i < this.$padding + 2 * this.layerConfig.characterWidth && (i = -this.scrollMargin.left),
        ...
        function (e, t, n) {
            ...
            var r = e('../lib/oop'),
                ...
                u = function (t, n, r, i) {
                    ...
                    (this.$worker.postMessage({ init: !0, tlns: u, module: n, classname: r }),
                        (this.callbackId = 1),
                        (this.callbacks = {}),
        ...
        function (e, t, n) {
            ...
            function o(e) {
                ...
                if (l.$mouseHandler.$enableJumpToDef)
                    (u && n) || (a && n) ? (S = o ? 'block' : 'add') : n && l.$blockSelectEnabled && (S = 'block');
                else if (a && !n) {
                    S = 'add';
                    if (!h && o) return;
                ...
                if (S == 'add') {
                    ...
                    (l.$blockScrolling++,
                        ...
                        l.once('mouseup', function () {
                            ...
                            (T && e.isEmpty() && s(T.cursor, e.cursor)
                                ...
                                : (o ? c.substractPoint(x.cursor) : x && (l.removeSelectionMarker(x), c.addRange(x)),
                                  c.addRange(e)),
                                l.$blockScrolling--,
                    ...
                    (l.$blockScrolling++,
                        h && !a ? c.toSingleRange() : !h && a && ((N = c.toOrientedRange()), l.addSelectionMarker(N)),
        ...
        function (e, t, n) {
            ...
            ((function () {
                ((this.getRowLength = function (e) {
                    var t;
                    return (
                        this.lineWidgets ? (t = (this.lineWidgets[e] && this.lineWidgets[e].rowCount) || 0) : (t = 0),
                    ...
                    (this.addLineWidget = function (e) {
                        ...
                        (t &&
                            ((e.$oldWidget = t),
                            t.el && t.el.parentNode && (t.el.parentNode.removeChild(t.el), (t._inDocument = !1))),
                            (this.session.lineWidgets[e.row] = e),
                            (e.session = this.session));
                        var n = this.editor.renderer;
                        (e.html && !e.el && ((e.el = i.createElement('div')), (e.el.innerHTML = e.html)),
                            e.el &&
                            ...
                            e.rowCount == null && (e.rowCount = e.pixelHeight / n.layerConfig.lineHeight));
                    ...
                    (this.renderWidgets = function (e, t) {
                        ...
                        for (var o = i; o <= s; o++) {
                            ...
                            (u.fixedWidth || (f -= t.scrollLeft),
                                ...
                                u.fullWidth && u.screenWidth && (u.el.style.minWidth = n.width + 2 * n.padding + 'px'),
                                u.fixedWidth
