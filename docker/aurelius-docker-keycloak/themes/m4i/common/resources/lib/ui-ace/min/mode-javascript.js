                    ...
                    (this.add('braces', 'insertion', function (e, t, n, r, i) {
                        ...
                        if (i == '{') {
                            ...
                            if (p.isSaneInsertion(n, r))
                                return /[\]\}\)]/.test(u[s.column]) || n.inMultiSelectMode
                                    ? (p.recordAutoInsert(n, r, '}'), { text: '{}', selection: [1, 1] })
                            ...
                            if (d == '}') {
                                ...
                                if (v !== null && p.isAutoInsertedClosing(s, u, i))
                                    return (p.popAutoInsertedClosing(), { text: '', selection: [1, 1] });
                            }
                        } else {
                            if (i == '\n' || i == '\r\n') {
                                c(n);
                                var m = '';
                                p.isMaybeInsertedClosing(s, u) &&
                                    ((m = o.stringRepeat('}', f.maybeInsertedBrackets)), p.clearMaybeInsertedClosing());
                                var d = u.substring(s.column, s.column + 1);
                                if (d === '}') {
                        ...
                        this.add('parens', 'insertion', function (e, t, n, r, i) {
                            if (i == '(') {
                                ...
                                if (p.isSaneInsertion(n, r))
                                    return (p.recordAutoInsert(n, r, ')'), { text: '()', selection: [1, 1] });
                            } else if (i == ')') {
                                c(n);
