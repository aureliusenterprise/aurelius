                ...
                function (_dereq_, module, exports) {
                    (function (global) {
                        (function () {
                            ...
                            var root =
                                freeGlobal || (freeWindow !== (this && this.window) && freeWindow) || freeSelf || this;
                            ...
                            var ArrayBuffer = isNative((ArrayBuffer = root.ArrayBuffer)) && ArrayBuffer,
                                bufferSlice =
                                    isNative((bufferSlice = ArrayBuffer && new ArrayBuffer(0).slice)) && bufferSlice,
                                floor = Math.floor,
                                getOwnPropertySymbols =
                                    isNative((getOwnPropertySymbols = Object.getOwnPropertySymbols)) &&
                                    getOwnPropertySymbols,
                                getPrototypeOf = isNative((getPrototypeOf = Object.getPrototypeOf)) && getPrototypeOf,
                                push = arrayProto.push,
                                preventExtensions =
                                    isNative((Object.preventExtensions = Object.preventExtensions)) &&
                                    preventExtensions,
                            ...
                            function baseMatches(source) {
                                ...
                                return function (object) {
                                    return (
                                        object != null &&
                                        baseIsMatch(toObject(object), props, values, strictCompareFlags)
                                    );
                                };
                            }
                            ...
                            var getSymbols = !getOwnPropertySymbols
                                ? constant([])
                                : function (object) {
                            ...
                            var isFunction = !(baseIsFunction(/x/) || (Uint8Array && !baseIsFunction(Uint8Array)))
                                ? baseIsFunction
                                : function (value) {
                    ...
                    var JSHINT = (function () {
                        ...
                        function expression(rbp, initial) {
                            ...
                            if (initial === true && state.tokens.curr.fud) {
                                ...
                                while (
                                    (rbp < state.tokens.next.lbp || state.tokens.next.type === '(template)') &&
                                    !isEndOfExpr()
                                ) {
                        ...
                        infix(
                            ...
                            function (left, that) {
                                ...
                                if (left && left.value === 'arguments' && (m === 'callee' || m === 'caller')) {
                                    if (state.option.noarg) warning('W059', left, m);
                                    else if (state.isStrict()) error('E008');
                                } else if (
                                    !state.option.evil &&
                                    left &&
                                    left.value === 'document' &&
                            ...
                            if (exprs.length > 1) {
                                ...
                                if (!isNecessary) {
                                    isNecessary =
                                        ...
                                        (triggerFnExpr && (!isEndOfExpr() || state.tokens.prev.id !== '}')) ||
                        ...
                        function isMethod() {
                            return (
                                (state.funct['(statement)'] && state.funct['(statement)'].type === 'class') ||
                            ...
                            for (;;) {
                                ...
                                if (state.tokens.next.id === '=') {
                                    ...
                                    if (peek(0).id === '=' && state.tokens.next.identifier) {
                                        if (
                                            (!prefix && report && !state.funct['(params)']) ||
                            ...
                            for (var i = 0; state.tokens.next.id !== '}'; ++i) {
                                ...
                                if (name.id === '[') {
                                    ...
                                    warning(
                                        'W052',
                                        state.tokens.next,
                                        state.tokens.next.value || state.tokens.next.type,
                                    );
                                    advance();
                                    continue;
                                }
                                ...
                                if (getset && name.value === 'constructor') {
                                    var propDesc =
                                        getset.value === 'get' ? 'class getter method' : 'class setter method';
                        ...
                        blockstmt('for', function () {
                            ...
                            do {
                                ...
                                level > 0 ||
                                (!_.contains(inof, nextop.value) && nextop.value !== ';' && nextop.type !== '(end)')
                            ); // Is this a JSCS bug? This looks really weird.
                        ...
                        (function (x) {
                            ...
                            prefix('yield', function () {
                                ...
                                if (state.inES6(true) && !state.funct['(generator)']) {
                                    if (
                                        !(
                                            '(catch)' === state.funct['(name)'] &&
                                            state.funct['(context)']['(generator)']
                                        )
                                    ) {
                                ...
                                if (state.tokens.next.id !== '}') {
                                    for (;;) {
                                        ...
                                        if (o[state.tokens.next.value] === true) {
                                            ...
                                            (state.tokens.next.value === '__iterator__' && !state.option.iterator)
                                        ) {
                            ...
                            if (o) {
                                ...
                                for (x = 0; x < optionKeys.length; x++) {
                                    if (/^-W\d{3}$/g.test(optionKeys[x])) {
                                        ...
                                        if (
                                            (optionKey === 'esversion' && o[optionKey] === 5) ||
            ...
            '/node_modules/jshint/src/messages.js': [
                function (_dereq_, module, exports) {
                    ...
                    var warnings = {
                        ...
                        W020: 'Read only.',
                        W021:
                            "Reassignment of '{a}', which is is a {b}. " +
                        ...
                        W129:
                            "'{a}' is defined in a future version of JavaScript. Use a " +
                    ...
                    var scopeManager = function (state, predefined, exported, declared) {
                        ...
                        function _checkForUnused() {
                            ...
                            for (var labelName in curentLabels) {
                                if (curentLabels[labelName]) {
                                    if (
                                        curentLabels[labelName]['(type)'] !== 'exception' &&
                        ...
                        var scopeManagerInst = {
                            ...
                            unstack: function () {
                                ...
                                for (i = 0; i < usedLabelNameList.length; i++) {
                                    ...
                                    if (usedLabel) {
                                        ...
                                        if (
                                            (usedLabelType === 'function' || usedLabelType === 'class') &&
                                            usage['(reassigned)']
                                        ) {
                                    ...
                                    if (subScope) {
                                        if (!subScope['(usages)'][usedLabelName]) {
                                            ...
                                            subScopeUsage['(modified)'] = subScopeUsage['(modified)'].concat(
                                                usage['(modified)'],
                                            );
                                            subScopeUsage['(tokens)'] = subScopeUsage['(tokens)'].concat(
                                                usage['(tokens)'],
                                            );
                                            subScopeUsage['(reassigned)'] = subScopeUsage['(reassigned)'].concat(
                                                usage['(reassigned)'],
                                            );
                                        ...
                                        if (typeof _current['(predefined)'][usedLabelName] === 'boolean') {
                                            ...
                                            if (
                                                _current['(predefined)'][usedLabelName] === false &&
                                                usage['(reassigned)']
                                            ) {
                                                for (j = 0; j < usage['(reassigned)'].length; j++) {
                                                ...
                                                for (j = 0; j < usage['(tokens)'].length; j++) {
                                                    ...
                                                    if (!undefinedToken.forgiveUndef) {
                                                        ...
                                                        if (impliedGlobals[usedLabelName]) {
                                                            impliedGlobals[usedLabelName].line.push(
                                                                undefinedToken.line,
                                                            );
                                                        } else {
                                ...
                                if (
                                    subScope &&
                                    !isUnstackingFunctionBody &&
                                    !isUnstackingFunctionParams &&
                                    !isUnstackingFunctionOuter
                                ) {
                                    var labelNames = Object.keys(currentLabels);
                                    for (i = 0; i < labelNames.length; i++) {
                                        var defLabelName = labelNames[i];
                                        if (
                                            !currentLabels[defLabelName]['(blockscoped)'] &&
                                ...
                                if (isUnstackingFunctionBody) {
                                    _currentFunctBody =
                                        _scopeStack[
                                            _.findLastIndex(_scopeStack, function (scope) {
                            ...
                            addlabel: function (labelName, opts) {
                                ...
                                var isexported =
                                    (isblockscoped ? _current : _currentFunctBody)['(type)'] === 'global' &&
                            ...
                            funct: {
                                labeltype: function (labelName, options) {
                                    ...
                                    var currentScopeIndex =
                                        _scopeStack.length - (options && options.excludeCurrent ? 2 : 1);
                            ...
                            block: {
                                ...
                                use: function (labelName, token) {
                                    ...
                                    if (
                                        paramScope &&
                                        paramScope['(labels)'][labelName] &&
                                        paramScope['(labels)'][labelName]['(type)'] === 'param'
                                    ) {
                                        if (
                                            !scopeManagerInst.funct.has(labelName, {
                                                excludeParams: true,
