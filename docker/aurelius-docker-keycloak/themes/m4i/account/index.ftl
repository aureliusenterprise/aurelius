...
<html>
    <head>
        ...
        <script>
            ...
            <#else>
            var brandImg = resourceUrl + '/img/m4i-logo-notext.png';
            </#if>
        ...
        <link rel="icon" href="${resourceUrl}/img/favicon.ico" type="image/x-icon"/>
...
<div id="spinner_screen" style="display:block; height:100%">
    <div style="width: 320px; height: 328px; text-align: center; position: absolute; top:0; bottom: 0; left: 0; right: 0; margin: auto;">
        <img src="${resourceUrl}/img/m4i-logo-notext.png" alt="Aurelius Logo" class="brand">
      ...
      <header role="banner" class="pf-c-page__header">
        <div class="pf-c-page__header-brand">
          ...
          <a id="landingLogo" class="pf-c-page__header-brand-link" href="${baseUrl}">
            ...
            <img class="pf-c-brand brand" src="${resourceUrl}/img/m4i-logo-notext.png" alt="Aurelius Logo">
          </a>
        </div>
        <div class="pf-c-page__header-tools">
            ...
            <div class="pf-c-page__header-tools-group pf-u-display-none-on-md">
                <div id="landingMobileKebab" class="pf-c-dropdown pf-m-mobile" onclick="toggleMobileDropdown();">
