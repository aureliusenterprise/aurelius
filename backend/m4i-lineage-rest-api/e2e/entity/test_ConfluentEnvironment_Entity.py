...
def test_confluent_environment_get(client):
    t = client.get(path)
    assert t.status_code == 200
    # END test_confluent_environment_get
...
# END test_confluent_environment_post
...
# END test_confluent_environment_post_potency_double
