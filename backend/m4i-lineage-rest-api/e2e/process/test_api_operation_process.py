...
def test_api_operation_process_get(client):
    t = client.get(path)
    assert t.status_code == 200
    # END test_api_operation_process_get
...
# END test_api_operation_process_post
...
# END test_api_operation_process_post_potency_double
