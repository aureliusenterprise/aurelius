...
from m4i_atlas_core import ConfigStore, data_dictionary_entity_type_mapping, register_atlas_entity_types
...
from .lin_api.kubernetes.kubernetes_environment.kubernetes_environment import (
    ns as kubernetes_environment_namespace,
)
...
from .lin_api.kubernetes.kubernetes_deployment.kubernetes_deployment import (
    ns as kubernetes_deployment_namespace,
)
...
from .lin_api.process.ingress_controller_process.ingress_controller_process import (
    ns as ingress_controller_process_namespace,
)
from .lin_api.process.ingress_object_process.ingress_object_process import (
    ns as ingress_object_process_namespace,
)
from .lin_api.process.kubernetes_service_process.kubernetes_service_process import (
    ns as kubernetes_service_process_namespace,
)
...
class flask_app(object):
    ...
    def run_app(self):
        self.log.info(
            ">>>>> Starting development server at http://{}/lin_api/ <<<<<".format(
...
def init_config():
    ...
    # register_atlas_entity_types(kubernetes_entity_type_mapping)
    # register_atlas_entity_types(connectors_entity_type_mapping)
    return store
