...
def test_m4i_ksql_model_no_env(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"env": "'env' is a required property"}
...
def test_m4i_ksql_model_no_kafka_topic(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"kafka_topic": "'kafka_topic' is a required property"}
...
def test_m4i_ksql_model_no_value_format(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"value_format": "'value_format' is a required property"}
...
def test_m4i_ksql_model_no_query(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"query": "'query' is a required property"}
...
def test_m4i_ksql_model_no_properties(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"properties": "'properties' is a required property"}
