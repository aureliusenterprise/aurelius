...
class StringOrObjectElementV2(fields.Raw):
...
class StringOrObjectElement(fields.Nested):
    ...
    def schema(self):
        ...
        schema_dict["oneOf"] = [{"type": "string"}, {"$ref": nested_ref}]
        return schema_dict
...
m4i_kafkaTopic_entity_field = api.model(
...
m4i_kafkaTopic_entity_fields = api.model(
...
m4i_kafkaTopic_entity_model = api.model(
    "model_m4i_kafkaTopic_entity",
    {
        "name": fields.String(required=True, description="The name of hte kafka topic"),
        "environment": fields.String(
            required=True, description="The name of the confluent environment the kafka topic is on"
        ),
        "cluster": fields.String(
            required=True, description="The name of kafka cluster the kafka topic is on"
        ),
        "partitions": fields.Integer(
            required=True, description="The partitions configured for the kafka topic"
        ),
        "replicas": fields.Integer(required=True, description="The replicas configured for the kafka topic"),
        "key_schema": fields.String(
            required=True, description="The key schema configured for the kafka topic"
        ),  # avo
        "value_schema": StringOrObjectElement(
            m4i_kafkaTopic_entity_fields,
            required=True,
