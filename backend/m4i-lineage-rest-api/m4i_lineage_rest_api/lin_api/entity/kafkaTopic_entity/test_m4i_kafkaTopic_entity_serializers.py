...
def test_m4i_kafkaTopic_entity_model_no_cluster(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"cluster": "'cluster' is a required property"}
...
def test_m4i_kafkaTopic_entity_model_no_partitions(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"partitions": "'partitions' is a required property"}
...
def test_m4i_kafkaTopic_entity_model_string_partitions(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"partitions": "'3' is not of type 'integer'"}
...
def test_m4i_kafkaTopic_entity_model_no_replicas(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"replicas": "'replicas' is a required property"}
...
def test_m4i_kafkaTopic_entity_model_string_replicas(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"replicas": "'3' is not of type 'integer'"}
...
def test_m4i_kafkaTopic_entity_model_no_key_schema(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"key_schema": "'key_schema' is a required property"}
...
def test_m4i_kafkaTopic_entity_model_no_value_schema(client, request_to_make):
    ...
    t_json = t.get_json()
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {"value_schema": "'value_schema' is a required property"}
...
def test_m4i_kafkaTopic_entity_model_value_schema_no_name(client, request_to_make):
    ...
    request_value_schema_no_name["value_schema"] = {"fields": [], "doc": "doc_field", "type": "a type"}
    ...
    assert t_json["errors"] == {
        "value_schema": "{'doc': 'doc_field', 'fields': [], 'type': 'a type'} is not "
...
def test_m4i_kafkaTopic_entity_model_value_schema_no_doc(client, request_to_make):
    ...
    request_value_schema_no_doc["value_schema"] = {"fields": [], "name": "some Name", "type": "a type"}
    ...
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {
        "value_schema": "{'fields': [], 'name': 'some Name', 'type': 'a type'} is not "
        "valid under any of the given schemas"
    }
...
def test_m4i_kafkaTopic_entity_model_value_schema_no_type(client, request_to_make):
    ...
    request_value_schema_no_type["value_schema"] = {"fields": [], "name": "some Name", "doc": "doc_field"}
    ...
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {
        "value_schema": "{'doc': 'doc_field', 'fields': [], 'name': 'some Name'} is "
...
def test_m4i_kafkaTopic_entity_model_value_schema_no_fields(client, request_to_make):
    ...
    assert t_json["message"] == "Input payload validation failed"
    assert t_json["errors"] == {
        "value_schema": "{'doc': 'doc_field', 'name': 'some Name', 'type': 'a type'} "
