...
from .m4i_elasticIndex_entity_serializers import (
    m4i_elasticIndex_entity_model as elasticIndex_entity_serializer,
)
...
class dashboard_Class(Resource):
    ...
    def post(self, access_token=None):
        ...
        data_read_response = asyncio.run(
            create_entities(*entity, referred_entities=ref, access_token=access_token)  # type: ignore[call-arg]
        )
