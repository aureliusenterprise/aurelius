...
from m4i_atlas_core import (
    ObjectId,
    M4IAttributes,
    KafkaCluster as CoreKafkaCluster,
...
class KafkaClusterBase(DataClassJsonMixin):
    ...
    def _qualified_name(self):
        ...
        return get_qualified_name(self.name, prefix=self.confluent_environment)
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class KafkaCluster(KafkaClusterDefaultsBase, KafkaClusterBase):
    def convert_to_atlas(self) -> CoreKafkaCluster:
        ...
        confluent_environment_unique_attributes = M4IAttributes(qualified_name=self.confluent_environment)
        ...
        entity = CoreKafkaCluster(attributes=attributes)
