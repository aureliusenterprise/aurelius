...
from .m4i_elasticCluster_entity_serializers import (
    m4i_elasticCluster_entity_model as elasticCluster_entity_serializer,
)
...
class elasticCluster_Class(Resource):
    ...
    def get(self, access_token=None):
        ...
        search_result = asyncio.run(
            get_entities_by_type_name("m4i_elastic_cluster", access_token=access_token)
        )
