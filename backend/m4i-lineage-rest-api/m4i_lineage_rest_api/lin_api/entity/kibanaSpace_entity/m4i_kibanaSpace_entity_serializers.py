...
m4i_kibanaSpace_entity_model = api.model(
    "model_m4i_kibanaSpace_entity",
    {
        ...
        "avatar_initials": fields.String(
            required=True, description="The avatar_initials of the kibana space"
        ),
        "elastic_cluster": fields.String(
            required=True, description="The qualifiedName of the elastic cluster the kibana space is on"
        ),
