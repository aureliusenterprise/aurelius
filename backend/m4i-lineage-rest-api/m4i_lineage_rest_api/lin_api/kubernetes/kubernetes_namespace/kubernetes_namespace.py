...
from .kubernetes_namespace_serializers import (
    m4i_kubernetes_namespace_model as kubernetes_namespace_serializer,
)
...
class kubernetes_namespace_Class(Resource):
    ...
    def get(self, access_token=None):
        ...
        search_result = asyncio.run(
            get_entities_by_type_name("m4i_kubernetes_namespace", access_token=access_token)
        )
