...
from m4i_atlas_core.entities.atlas.kubernetes import (
    KubernetesDeployment as CoreKubernetesDeployment,
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class KubernetesDeployment(KubernetesDeploymentDefaultsBase, KubernetesDeploymentBase):
    def convert_to_atlas(self) -> CoreKubernetesDeployment:
        ...
        entity = CoreKubernetesDeployment(attributes=attributes)
