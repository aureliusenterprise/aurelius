...
from .kubernetes_deployment_serializers import (
    m4i_kubernetes_deployment_model as kubernetes_deployment_serializer,
)
...
class kubernetes_deployment_Class(Resource):
    ...
    def get(self, access_token=None):
        ...
        search_result = asyncio.run(
            get_entities_by_type_name("m4i_kubernetes_deployment", access_token=access_token)
        )
