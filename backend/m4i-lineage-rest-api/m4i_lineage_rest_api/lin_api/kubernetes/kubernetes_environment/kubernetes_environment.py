...
from .kubernetes_environment_serializers import (
    m4i_kubernetes_environment_model as kubernetes_environment_serializer,
)
...
class kubernetes_environment_Class(Resource):
    ...
    def get(self, access_token=None):
        ...
        search_result = asyncio.run(
            get_entities_by_type_name("m4i_kubernetes_environment", access_token=access_token)
        )
