...
def test_m4i_kubernetes_environment_model_no_kubernetes_clusters(
    ...
    assert t_json["errors"] == {"kubernetesClusters": "'kubernetesClusters' is a required property"}


# END test_m4i_kubernetes_environment_model_no_description


def test_m4i_kubernetes_environment_model_empty_kubernetes_cluster(
    client, request_to_make, check_made, cleanup
):
