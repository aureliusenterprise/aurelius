...
m4i_kubernetes_service_process_model = api.inherit(
    "model_m4i_kubernetes_service_process",
    m4i_generic_entity_model,
    {
        "processOwner": fields.String(
            required=False, description="Qualified Name of processOwner of Process Entity"
        ),
        "inputs": fields.List(
            fields.String(),
            required=True,
        ...
        "microservice": fields.List(
            fields.String(),
            required=True,
            description="List Qualified Name microservices known by the Kubernetes Service Entity",
        ),
        "namespace": fields.String(
            required=True, description="The namespace that the Kubernetes Service is on"
        ),
        "ingressObject": fields.String(
            required=False, description="The ingress object that knows the Kubernetes Service"
        ),
    },
)
