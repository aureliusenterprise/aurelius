...
from m4i_atlas_core.entities.atlas.processes import (
    ConnectorProcess as CoreConnectorProcess,
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class ConnectorProcess(ConnectorProcessDefaultsBase, ConnectorProcessBase):
    def convert_to_atlas(self) -> CoreConnectorProcess:
        ...
        entity = CoreConnectorProcess(attributes=attributes)
