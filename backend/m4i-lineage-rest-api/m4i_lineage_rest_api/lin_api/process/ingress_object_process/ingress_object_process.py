...
from .ingress_object_process_seralizer import (
    m4i_ingress_object_process_model as ingress_object_process_serializer,
)
...
class ingress_object_process_Class(Resource):
    ...
    def get(self, access_token=None):
        ...
        search_result = asyncio.run(
            get_entities_by_type_name("m4i_ingress_object_process", access_token=access_token)
        )
