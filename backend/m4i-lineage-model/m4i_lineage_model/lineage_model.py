...
from m4i_atlas_core import ConfigStore, LineageDirection, LineageInfo, LineageRelation, get_lineage_by_guid
...
process_types = [
    ...
    "m4i_kubernetes_service_process",
        ...
        "elements": [
            {
                ...
                "mapping": [{"key": "Type name", "value": "from_entity_type"}],
                "include": True,
                "type": "element",
            },
            {
                ...
                "concept_label_key": None,
                "concept_label_prefix": None,
                "mapping": [{"key": "Type name", "value": "to_process_type"}],
                "include": True,
                "type": "element",
            },
            {
                ...
                "concept_label_key": None,
                "concept_label_prefix": None,
                "mapping": [{"key": "Type name", "value": "from_process_type"}],
                "include": True,
                "type": "element",
            },
            {
                ...
                "concept_label_key": None,
                "concept_label_prefix": None,
                "mapping": [{"key": "Type name", "value": "to_entity_type"}],
                "include": True,
                "type": "element",
            },
        ],
        "relations": [
            {
                ...
                "description": (
                    "This rule generates a new relationship between from_entity_id and to_process_id"
                ),
                "include": True,
                "relationship_type": "lr",
                "id_type": "dynamic",
                "id_key": "id",
                "id_value": ["from_entity_id", "to_process_id"],
            ...
            },
            {
                ...
                "description": (
                    "This rule generates a new relationship between from_process_id and to_entity_id"
                ),
                "include": True,
                "relationship_type": "lr",
                "id_type": "dynamic",
                "id_key": "id",
                "id_value": ["from_process_id", "to_entity_id"],
                "relationship_name_type": "dynamic",
                "relationship_name_key": "",
                "relationship_label_type": "dynamic",
                "relationship_label_key": "",
...
def lineage_model(access_token=None):
    ...
    try:
        lineage = loop.run_until_complete(
            get_lineage_by_guid(guid=guid, depth=depth, direction=direction, access_token=access_token)
        )
    ...
    if lineage is None or len(lineage.relations) == 0:
        return ("", 204)
    # END IF

    lineage_relations = [fmt_lineage_relation(relation, lineage) for relation in lineage.relations]

    data2model_request_body = {"data": lineage_relations, **rules}
