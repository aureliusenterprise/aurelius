...
def get_all_documents(app_search_client: AppSearch, engine_name: str) -> List[MutableMapping[str, Any]]:
    response = app_search_client.list_documents(engine_name=engine_name, page_size=1000, current_page=1)
