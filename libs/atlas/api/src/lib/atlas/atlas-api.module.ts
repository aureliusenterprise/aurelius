...
import { HttpCacheService, HttpModule, HttpService } from '@models4insight/http';
...
@NgModule({
    ...
    providers: [AtlasApiClient, ClassificationDefAPIService, EntityAPIService, TypeDefAPIService],
})
