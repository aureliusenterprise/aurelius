...
@Directive({
    selector: 'models4insight-has-keycloak-role-permission, [models4insight-has-keycloak-role-permission]',
})
export class HasKeycloakRolePermissionDirective extends AbstractKeycloakRolePermissionDirective {
    ...
    constructor(keycloakService: KeycloakService, templateRef: TemplateRef<any>, viewContainer: ViewContainerRef) {
