...
@Directive({
    selector: 'models4insight-intersection-observer, [models4insight-intersection-observer]',
...
export class IntersectionObserverDirective implements OnInit, OnDestroy {
    ...
    constructor(private readonly intersectionObserver: IntersectionObserverService) {}
    ...
    ngOnInit() {
        ...
        this.intersectionObserver.onIntersection.pipe(untilDestroyed(this)).subscribe(this.intersection);
    }
