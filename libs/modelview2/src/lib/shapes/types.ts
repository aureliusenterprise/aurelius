import { ModelElement, ModelRelation, ModelViewConnection, ModelViewNode } from '../parsers';
...
export type NodeShapeFunction = (node: ModelViewNode, element?: ModelElement) => NodeShapeDefinition;
