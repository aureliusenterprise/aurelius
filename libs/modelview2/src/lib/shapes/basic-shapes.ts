...
type BasicShape = 'ellipse' | 'octagon' | 'parallelogram' | 'rectangle' | 'roundedRectangle';
...
export const basicShapes: { [key in BasicShape]: BasicShapeFunction } = {
    ...
    octagon: (width, height) =>
        `m12,0h${width - 24}l12,12v${height - 24}l-12,12h-${width - 24}l-12,-12v-${height - 24}l12,-12z`,
    parallelogram: (width, height) => `m${width * 0.1},0h${width * 0.9}l-${width * 0.1},${height}h${width * 0.9},0z`,
