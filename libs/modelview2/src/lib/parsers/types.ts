...
export type ParserType = 'element' | 'relationship' | 'view' | 'node' | 'connection';

export type ModelEntity = ModelElement | ModelRelation | ModelView | ModelViewNode | ModelViewConnection;
...
export type ModelParserFunction = (jsonModel: any) => Promise<ModelParserResult>;
