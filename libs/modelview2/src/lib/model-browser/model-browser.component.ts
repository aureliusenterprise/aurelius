    ...
    private initTabs() {
        this.tabs = {
            browse: {
                ...
                displayName: 'modelview2.modelBrowser.modelBrowserBrowse',
            },
            model: {
                id: 'model',
                component: ModelBrowserModelComponent,
                displayName: 'modelview2.modelBrowser.modelBrowserModel',
            },
            view: {
                id: 'view',
                component: ModelBrowserViewComponent,
                displayName: 'modelview2.modelBrowser.modelBrowserView',
                condition: this.selectedView$,
            },
            selection: {
                id: 'selection',
                component: ModelBrowserSelectionComponent,
                displayName: 'modelview2.modelBrowser.modelBrowserSelection',
