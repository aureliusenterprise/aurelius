...
export class PalletteSelectComponent extends AbstractSelectComponent<PalletteSelectOption> implements OnInit {
    ...
    ngOnInit() {
        ...
        this.colorViewService
            ...
            .subscribe((palette) => this.control.patchValue(optionsByPalette[palette], { emitEvent: false }));

        // Whenever a new palette is selected, update the store
        this.control.valueChanges.pipe(untilDestroyed(this)).subscribe(({ pallette }) =>
