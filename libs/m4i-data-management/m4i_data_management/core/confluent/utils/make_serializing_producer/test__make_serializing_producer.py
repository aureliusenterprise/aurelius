...
def test__make_serializing_producer_can_push_message():
    ...
    producer = make_serializing_producer(key_schema_id="100021", value_schema_id="100022")
    ...
    producer.produce(topic=topic_name, key=key, value=value, on_delivery=evaluate)
