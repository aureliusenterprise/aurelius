...
from m4i_data_management.core.quality.utils.run_quality_check.run_quality_check import run_quality_check
...
def test__run_quality_check_detailed_results_must_be_dataframe(data: DataFrame, rule_a: Series):
    ...
    assert isinstance(compliant, DataFrame) and isinstance(non_compliant, DataFrame)
