...
from m4i_data_management.core.quality.utils.evaluate_data_quality_rules.evaluate_data_quality_rules import (
...
def test__evaluate_data_quality_rules_must_annotate_results_with_metadata(data: DataFrame, rules: DataFrame):
    results, compliant, non_compliant = evaluate_data_quality_rules(data=data, rules=rules)
