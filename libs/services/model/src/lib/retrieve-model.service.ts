...
export class RetrieveModelService extends BasicStore<RetrieveModelStoreContext> {
    ...
    retrieveModel(branchId: string, contentType: ModelCommitContentTypeEnum, version?: number) {
    ...
    private async handleRetrieveModel(branchId: string, contentType: ModelCommitContentTypeEnum, version: number) {
