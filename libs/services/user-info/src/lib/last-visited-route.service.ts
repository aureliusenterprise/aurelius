...
export class LastVisitedRouteService {
    ...
    async getLastVisitedRoute() {
        const lastVisitedUrl = await this.userInfoService.get(['userInfo', 'last_visited']);
    ...
    selectLastVisitedRoute() {
        return this.userInfoService
            ...
            .pipe(map((lastVisitedUrl) => this.handleFormatLastVisitedRoute(lastVisitedUrl)));
    }
    ...
    private handleFormatLastVisitedRoute(lastVisitedUrl: string): LastVisitedRoute {
