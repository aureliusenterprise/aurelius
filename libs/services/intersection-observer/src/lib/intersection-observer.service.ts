...
export class IntersectionObserverProvider extends IntersectionObserver implements OnDestroy {
    private readonly elementsIntersectionStateChanged$ = new Subject<IntersectionObserverEntry[]>();
...
export class IntersectionObserverService implements OnDestroy {
    ...
    private async handleIntersectionStateChange(events: IntersectionObserverEntry[]) {
