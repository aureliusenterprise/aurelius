...
export function compareModels(
    ...
    { baseVersion, forceUpdate, otherVersion }: CompareModelsOptions & GetOptions = {},
    ...
    return http.authorize().cache(forceUpdate).get<ModelCompareResult>(path, requestOptions);
}
