...
export class ContextMenuComponent implements OnInit, OnDestroy {
    private readonly menuItems$: Subject<ContextMenuItems> = new BehaviorSubject<ContextMenuItems>([]);

    readonly filteredMenuItems$: Subject<ContextMenuItems> = new ReplaySubject<ContextMenuItems>();
