...
import { faInfo, faShieldAlt, faUserCog, faUserPlus } from '@fortawesome/free-solid-svg-icons';
...
import { leadingOrTrailingWhitespace, multipleWhitespaces, unique } from './validators';
...
export class CreateUserGroupModalComponent extends AbstractModalForm<UserGroup> implements OnInit {
    ...
    ngOnInit() {
        ...
        this.submission
            ...
            .subscribe((userGroup) => this.projectUserGroupsService.updateUserGroup(userGroup));
