...
import { ControlShellContext, defaultControlShellContext, AbstractControlShell } from '../control-shell';
...
export class BranchNameInputComponent extends AbstractControlShell implements OnInit {
