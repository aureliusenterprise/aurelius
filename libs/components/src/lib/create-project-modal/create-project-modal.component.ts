...
export class CreateProjectModalComponent extends AbstractModalForm<Project> implements OnInit {
    ...
    ngOnInit() {
        ...
        this.submission.pipe(untilDestroyed(this)).subscribe((project) => this.projectsService.createProject(project));
    }
