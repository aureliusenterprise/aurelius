...
export class SortableTableShellComponent<T extends Dictionary<any> = Dictionary<any>> implements OnInit, OnDestroy {
    @ContentChild(TemplateRef, { static: true })
    readonly row: TemplateRef<any>;

    @Output() readonly pageChanged: EventEmitter<number> = new EventEmitter<number>();
    ...
    @Output() readonly rowDeselected: EventEmitter<void> = new EventEmitter<void>();
    @Output() readonly rowIntersectionChanged: EventEmitter<[T, boolean]> = new EventEmitter<[T, boolean]>();
    ...
    ngOnInit() {
        ...
        deselected.pipe(untilDestroyed(this)).subscribe(() => this.rowDeselected.emit());
