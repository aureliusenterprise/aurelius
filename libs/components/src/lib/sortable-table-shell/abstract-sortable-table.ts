import { EventEmitter, Input, OnDestroy, Output, ViewChild, Directive } from '@angular/core';
import { Dictionary } from 'lodash';
import { SortableTableShellComponent } from './sortable-table-shell.component';
import { SortableTableShellConfig } from './types';

@Directive()
export abstract class AbstractSortableTable<T extends Dictionary<any> = Dictionary<any>> implements OnDestroy {
    ...
    @Input() set rowComparator(rowComparator: (value: T, otherValue: T) => boolean) {
