...
const conflictResolutionTemplateSelectData: ConflictResolutionTemplateSelectOption[] = [
    {
        ...
        description: 'Replace the repository head with the new model or source branch',
    ...
    },
    {
        ...
        description: 'In case of conflicts, replace the repository with the new model or source branch',
