...
export class ProjectSelectComponent extends AbstractSelectComponent<Project> implements OnInit {
    ...
    ngOnInit() {
        ...
        this.control.valueChanges
            .pipe(untilDestroyed(this))
            .subscribe((project: Project) => this.projectService.setCurrentProject(project?.id));
    }
}
