...
export class QuickviewComponent {
    ...
    /** Translation key for the pin tooltip */
    @Input() pinTooltip = 'components.quickview.pinTooltip';

    /** Translation key for the unpin tooltip */
    @Input() unpinTooltip = 'components.quickview.unpinTooltip';
