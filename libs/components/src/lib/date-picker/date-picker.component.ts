...
export class DatePickerComponent extends AbstractControlShell implements OnInit, OnDestroy {
    /**
     * Emits a timestamp whenever the user selects a date, or null when the selection is empty or does not match a date.
     */
    @Output() readonly dateChanged: EventEmitter<number | null> = new EventEmitter<number | null>();
