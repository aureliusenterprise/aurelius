...
const membersTableConfig: SortableTableShellConfig = {
    ...
    permission: {
        ...
        description: 'Defines the level of access this user has to models in this branch',
        isStatic: true,
    },
    remove_member: {
        isNarrow: true,
...
export class BranchMembersComponent implements OnInit {
    ...
    constructor(private readonly createBranchModalService: CreateBranchModalService) {}
    ...
    updateUserPermission(username: string, permissionLevel: BranchPermissionLevel) {
