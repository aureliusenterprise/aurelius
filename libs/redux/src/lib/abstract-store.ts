...
import { distinctUntilChanged, filter, first, map, pairwise, pluck, scan, shareReplay } from 'rxjs/operators';
 ...
 */
@Injectable()
export abstract class AbstractStore<CONTEXT extends StoreContext, ACTION extends Action<CONTEXT> = Action<CONTEXT>>
    implements OnDestroy, Store<CONTEXT>
{
    ...
    constructor({
        ...
        this.actions$.pipe(this.reducer(), untilDestroyed(this)).subscribe(this.state$);
    }
     ...
     */
    get<P extends keyof CONTEXT>(path: P | [P], options?: { includeFalsy?: boolean }): Promise<CONTEXT[P]>;
    get<P extends keyof CONTEXT, Q extends keyof CONTEXT[P]>(
        path: [P, Q],
        options?: { includeFalsy?: boolean },
    ): Promise<CONTEXT[P][Q]>;
    get<P extends keyof CONTEXT, Q extends keyof CONTEXT[P], R extends keyof CONTEXT[P][Q]>(
        path: [P, Q, R],
        options?: { includeFalsy?: boolean },
    ...
    >(path: [P, Q, R, S], options?: { includeFalsy?: boolean }): Promise<CONTEXT[P][Q][R][S]>;
    get<
        P extends keyof CONTEXT,
        Q extends keyof CONTEXT[P],
        R extends keyof CONTEXT[P][Q],
    ...
    >(path: [P, Q, R, S, T], options?: { includeFalsy?: boolean }): Promise<CONTEXT[P][Q][R][S][T]>;
    ...
    select<P extends keyof CONTEXT, Q extends keyof CONTEXT[P], R extends keyof CONTEXT[P][Q]>(
        path: [P, Q, R],
        options?: { includeFalsy?: boolean },
    ...
    select<
        ...
        R extends keyof CONTEXT[P][Q],
        S extends keyof CONTEXT[P][Q][R],
    >(path: [P, Q, R, S], options?: { includeFalsy?: boolean }): Observable<CONTEXT[P][Q][R][S]>;
    select<
        P extends keyof CONTEXT,
        Q extends keyof CONTEXT[P],
        R extends keyof CONTEXT[P][Q],
        S extends keyof CONTEXT[P][Q][R],
        T extends keyof CONTEXT[P][Q][R][S],
    >(path: [P, Q, R, S, T], options?: { includeFalsy?: boolean }): Observable<CONTEXT[P][Q][R][S][T]>;
    select(path: string | (string | number)[], options: { includeFalsy?: boolean } = {}): Observable<any> {
        ...
        return result.pipe(
            ...
            filter(
                (value) =>
                    (value !== undefined && value !== null && !Number.isNaN(value)) || (options.includeFalsy && !value),
            ),
     ...
     * @param path the path of the state to observe
     */
    watch<S extends keyof SubType<CONTEXT, Dictionary<any>>, T extends CONTEXT[S]>(
        path: S | [S],
        options?: { includeFalsy?: boolean },
    ): Observable<T extends any[] ? T : T[keyof T][]>;
    watch<M extends keyof CONTEXT, S extends keyof SubType<CONTEXT[M], Dictionary<any>>, T extends CONTEXT[M][S]>(
        path: [M, S],
        options?: { includeFalsy?: boolean },
    ): Observable<T extends any[] ? T : T[keyof T][]>;
    watch<
    ...
    >(path: [M, N, S], options?: { includeFalsy?: boolean }): Observable<T extends any[] ? T : T[keyof T][]>;
    watch<
        M extends keyof CONTEXT,
        N extends keyof CONTEXT[M],
    ...
    >(path: [M, N, O, S], options?: { includeFalsy?: boolean }): Observable<T extends any[] ? T : T[keyof T][]>;
    watch<
        M extends keyof CONTEXT,
        N extends keyof CONTEXT[M],
        O extends keyof CONTEXT[M][N],
    ...
    >(path: [M, N, O, P, S], options?: { includeFalsy?: boolean }): Observable<T extends any[] ? T : T[keyof T][]>;
    watch(path: any, options: { includeFalsy?: boolean } = {}): Observable<any> {
        return this.select(path, options).pipe(
            ...
            pairwise(),
            map(([old, current]) => (old ? differenceWith(current, old, isEqual) : current)),
        );
    }
    ...
    private reducer() {
        return scan((state: CONTEXT, action: ACTION | ResetAction) => {
            ...
            if (!AbstractStore.production) {
                ...
                const logMessage = action.description ? `${action.type}: ${action.description}` : action.type;
    ...
    private reduceAction(state: CONTEXT, action: Action<CONTEXT> | ResetAction): CONTEXT {
