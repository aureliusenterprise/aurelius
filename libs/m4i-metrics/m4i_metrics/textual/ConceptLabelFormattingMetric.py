...
elems_non_compliant_config = MetricConfig(
    ...
    data={
        ...
        "name": MetricColumnConfig(displayName="Current name", description="The current name of the element"),
        "rec_name": MetricColumnConfig(
            displayName="Suggested name", description="The suggested name of the element"
        ),
    },
)
...
rels_non_compliant_config = MetricConfig(
    ...
    id_column="id",
    data={
        "id": MetricColumnConfig(displayName="ID", description="The identifier of the relationship"),
        "name": MetricColumnConfig(
            displayName="Current name", description="The current name of the relationship"
        ),
        "rec_name": MetricColumnConfig(
            displayName="Suggested name", description="The suggested name of the relationship"
        ),
    },
)
...
views_non_compliant_config = MetricConfig(
    ...
    id_column="id",
    data={
        "id": MetricColumnConfig(displayName="ID", description="The identifier of the view"),
        "name": MetricColumnConfig(displayName="Current name", description="The current name of the view"),
        "rec_name": MetricColumnConfig(
            displayName="Suggested name", description="The suggested name of the view"
        ),
    },
)
...
class ConceptLabelFormattingMetric(Metric):
    ...
    def calculate(model: Any) -> Dict[str, Any]:  # type: ignore[reportIncompatibleMethodOverride]
        ...
        elems["sentence"] = elems.name.apply(
        ...
        elems_non_compliant = elems[elems.sentence == config.NON_COMPLIANT_TAG][["id", "name", "rec_name"]]
        rels_non_compliant = rels[rels.sentence == config.NON_COMPLIANT_TAG][["id", "name", "rec_name"]]
        views_non_compliant = views[views.sentence == config.NON_COMPLIANT_TAG][["id", "name", "rec_name"]]
