...
generic_process_attributes_def = [
    AttributeDef(name="processOwner", type_name="array<m4i_person>", cardinality=Cardinality.SET),
    AttributeDef(name="system", type_name="array<m4i_system>", cardinality=Cardinality.SET),
]
...
end_1_person_gprocess = RelationshipEndDef(type="m4i_person", name="ProcessOwner")

end_2_person_gprocess = RelationshipEndDef(type="m4i_generic_process", name="processOwner")
...
end_1_system_msprocess = RelationshipEndDef(type="m4i_system", name="processes")

end_2_system_msprocess = RelationshipEndDef(type="m4i_generic_process", name="system")
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class GenericProcessAttributes(  # type: ignore[reportGeneralTypeIssues]
    GenericProcessAttributesDefaultsBase, GenericProcessAttributesBase
):
    pass
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class GenericProcess(GenericProcessDefaultsBase, GenericProcessBase, Entity):  # type: ignore[reportGeneralTypeIssues]
