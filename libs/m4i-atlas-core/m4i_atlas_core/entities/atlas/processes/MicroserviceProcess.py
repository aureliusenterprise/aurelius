...
microservice_process_attributes_def = [
    AttributeDef(name="system", type_name="array<m4i_kubernetes_pod>", cardinality=Cardinality.SET),
    AttributeDef(
        name="service", type_name="array<m4i_kubernetes_service_process>", cardinality=Cardinality.SET
    ),
    AttributeDef(name="operation", type_name="array<m4i_api_operation_process>", cardinality=Cardinality.SET),
]
...
end_1_system_msprocess = RelationshipEndDef(type="m4i_kubernetes_pod", name="microservice")
end_2_system_msprocess = RelationshipEndDef(type="m4i_microservice_process", name="system")
...
end_1_ksprocess_msprocess = RelationshipEndDef(type="m4i_kubernetes_service_process", name="microservice")
end_2_ksprocess_msprocess = RelationshipEndDef(type="m4i_microservice_process", name="service")
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class MicroserviceProcessAttributes(  # type: ignore[reportGeneralTypeIssues]
    GenericProcessAttributes, MicroserviceProcessAttributesDefaultsBase, MicroserviceProcessAttributesBase
):
    pass
...
class MicroserviceProcessBase(GenericProcessBase):
    attributes: MicroserviceProcessAttributes  # type: ignore[reportIncompatibleMethodOverride]
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class MicroserviceProcess(  # type: ignore[reportGeneralTypeIssues]
    GenericProcess, MicroserviceProcessDefaultsBase, MicroserviceProcessBase
):
