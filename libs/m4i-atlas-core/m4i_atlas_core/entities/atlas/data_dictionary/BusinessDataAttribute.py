...
data_attribute_attributes_def = [
    ...
    AttributeDef(
        ...
        is_indexable=False,
        description=(
            "The risk classification of the data attribute determined by the data steward and data owner"
        ),
...
end_1_entity_attribute = RelationshipEndDef(
    type="m4i_data_entity", name="attributes", cardinality=Cardinality.SET
)
end_2_entity_attribute = RelationshipEndDef(
    type="m4i_data_attribute", name="dataEntity", cardinality=Cardinality.SET
)
...
end_1_business_owner_attribute = RelationshipEndDef(
    type="m4i_person", name="businessOwnerAttribute", cardinality=Cardinality.SET
)
end_2_business_owner_attribute = RelationshipEndDef(
    type="m4i_data_attribute", name="businessOwner", cardinality=Cardinality.SET
)
...
end_1_steward_attribute = RelationshipEndDef(
    type="m4i_person", name="stewardAttribute", cardinality=Cardinality.SET
)
end_2_steward_attribute = RelationshipEndDef(
    type="m4i_data_attribute", name="steward", cardinality=Cardinality.SET
)
...
m4i_classification_key_data = ClassificationDef(
    name="key_data", entity_types=["m4i_data_attribute", "m4i_field"], category=TypeCategory.CLASSIFICATION
)
...
m4i_classification_medium_risk = ClassificationDef(
    name="medium_risk", entity_types=["m4i_data_attribute", "m4i_field"], category=TypeCategory.CLASSIFICATION
)
m4i_classification_low_risk = ClassificationDef(
    name="low_risk", entity_types=["m4i_data_attribute", "m4i_field"], category=TypeCategory.CLASSIFICATION
)
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class BusinessDataAttributeAttributes(
    BusinessDataAttributeAttributesDefaultsBase, BusinessDataAttributesAttributesBase
):
    pass
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class BusinessDataAttribute(  # type: ignore[reportGeneralTypeIssues]
    BusinessDataAttributeDefaultsBase, BusinessDataAttributeBase, Entity
):
