...
class EntityDef(StructDef):
    business_attribute_defs: Dict[str, List[AttributeDef]] = field(default_factory=dict)
    relationship_attribute_defs: List[RelationshipAttributeDef] = field(default_factory=list)
