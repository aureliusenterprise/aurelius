...
class RelationshipDefaultsBase(StructDefaultsBase):
    blocked_propagated_classifications: List[Classification] = field(default_factory=list)
    ...
    propagated_classifications: List[Classification] = field(default_factory=list)
