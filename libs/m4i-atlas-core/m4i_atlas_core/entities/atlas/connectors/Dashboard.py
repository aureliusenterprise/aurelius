...
end_1_kibana_dashboard = RelationshipEndDef(type="m4i_kibana_space", name="dashboards")
end_2_kibana_dashboard = RelationshipEndDef(type="m4i_dashboard", name="kibanaSpace")
...
end_1_person_dashboard = RelationshipEndDef(type="m4i_person", name="dashboards")
end_2_person_dashboard = RelationshipEndDef(type="m4i_dashboard", name="creator")
...
end_1_elastic_cluster_dashboard = RelationshipEndDef(type="m4i_elastic_cluster", name="dashboards")
end_2_elastic_cluster_dashboard = RelationshipEndDef(type="m4i_dashboard", name="elasticCluster")
...
class DashboardAttributes(
    BusinessDatasetAttributes, DashboardAttributesDefaultsBase, DashboardAttributesBase
):
    pass
...
class DashboardBase(BusinessDatasetBase):
    attributes: DashboardAttributes  # type: ignore[reportIncompatibleMethodOverride]
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class Dashboard(BusinessDataset, DashboardDefaultsBase, DashboardBase):  # type: ignore[reportGeneralTypeIssues]
