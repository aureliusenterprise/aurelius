...
index_pattern_attributes_def = [
    AttributeDef(name="creator", type_name="array<m4i_person>", cardinality=Cardinality.SET),
    AttributeDef(name="indexPattern", type_name="string"),
    AttributeDef(name="updatedAt", type_name="string"),
    AttributeDef(name="version", type_name="string"),
]
...
end_1_person_index_pattern = RelationshipEndDef(type="m4i_person", name="indexPatterns")
end_2_person_index_pattern = RelationshipEndDef(type="m4i_index_pattern", name="creator")
...
@dataclass
class IndexPatternAttributesBase(BusinessDatasetAttributesBase, BusinessCollectionAttributesBase):
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class IndexPatternAttributesDefaultsBase(
    BusinessDatasetAttributesDefaultsBase, BusinessCollectionAttributesDefaultsBase
):
...
class IndexPatternBase(BusinessDatasetBase, BusinessCollectionBase):
    attributes: IndexPatternAttributes  # type: ignore[reportIncompatibleMethodOverride]
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class IndexPattern(  # type: ignore[reportGeneralTypeIssues]
    BusinessDataset, BusinessCollection, IndexPatternDefaultsBase, IndexPatternBase
):
    ...
    def get_referred_entities(self) -> Iterable[ObjectId]:
        ...
        * Atlas Person
        ...
        references = [*super().get_referred_entities(), *self.attributes.creator]
