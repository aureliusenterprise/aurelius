...
visualization_attributes_def = [
    AttributeDef(name="type", type_name="string"),
    ...
    AttributeDef(name="visualizationType", type_name="string"),
]
...
end_1_person_visualization = RelationshipEndDef(type="m4i_person", name="visualizations")
end_2_person_visualization = RelationshipEndDef(type="m4i_visualization", name="creator")
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class VisualizationAttributes(
    BusinessDatasetAttributes, VisualizationAttributesDefaultsBase, VisualizationAttributesBase
):
    pass
...
class VisualizationBase(BusinessDatasetBase):
    attributes: VisualizationAttributes  # type: ignore[reportIncompatibleMethodOverride]
...
@dataclass_json(letter_case=LetterCase.CAMEL)  # type: ignore[argument-type]
@dataclass
class Visualization(BusinessDataset, VisualizationDefaultsBase, VisualizationBase):  # type: ignore[reportGeneralTypeIssues]
