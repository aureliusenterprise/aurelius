...
@cached()
async def get_entities_by_type_name(
    type_name: str, limit: int = 100, offset: int = 0, access_token: Optional[str] = None
) -> List[EntityHeader]:
    """
    ...
    while True:
        params = {"typeName": type_name, "limit": limit, "offset": offset}
