...
async def get_referred_entities(entity: Entity) -> Iterable[Entity]:
    ...
    entity_references = (reference for reference in entity.get_referred_entities())

    referred_entities_co = (resolve_entity_header(header) for header in entity_references)
