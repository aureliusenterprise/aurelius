...
In order to deploy elastic the `Elastic Cluster on Kubernetes (ECK)` must be installed on the cluster. To
install ECK on the cluster, please follow the instructions provided on
