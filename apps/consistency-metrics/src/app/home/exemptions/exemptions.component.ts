...
const exemptionsTableConfig: SortableTableShellConfig<MetricExemption> = {
    concept_id: {
        ...
        description: 'The unique identifier of the concept to which this exemption applies',
    },
    metric: {
    ...
    branch: {
        ...
        description: 'The unique identifier of the branch to which this exemption applies',
    },
    version: {
        displayName: 'Timestamp',
        description: 'The timestamp of the model version to which this exemption applies',
        isTimestamp: true,
    },
    comment: {
...
export class ExemptionsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.isLoadingExemptions$ = this.exemptionsService.select('isLoadingExemptions');
