...
export class GenerateReportComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.route.queryParamMap
            ...
            .subscribe((queryParamMap) => this.projectService.setCurrentProject(queryParamMap.get('project')));
        ...
        this.route.queryParamMap
            ...
            .subscribe((branch) => {
                ...
                this.generateReportService.loadVersions(this.form.value.project, branch);
            });
            ...
            .pipe(
                switchMap((queryParamMap) =>
                    queryParamMap.has('version')
                        ? this.generateReportService.get(['versionsByTimestamp', queryParamMap.get('version')])
                        : EMPTY,
                ),
                untilDestroyed(this),
            )
            .subscribe((version) => this.form.patchValue({ version }, { emitEvent: false }));
    }
