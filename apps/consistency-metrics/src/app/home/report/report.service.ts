...
import { Report, ReportCategory, ReportMetric, ReportService as ApiService } from '../../core/report.service';
...
export class ReportService extends BasicStore<ReportStoreContext> {
    ...
    private async handleRetrieveMetric(metricKey: string) {
        ...
        const metric = await this.apiService.getMetric(project, branchName, metricKey, version).toPromise();
