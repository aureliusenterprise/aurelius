...
const exemptionScopeTableConfig: SortableTableShellConfig<ExemptionScopeSelectRow> = {
...
const exemptionScopeSelectData: ExemptionScopeSelectRow[] = [
    ...
    },
    {
        type: 'version',
        name: 'This version',
        description: 'This exemption should apply to the current version of the model',
    },
];
...
export class ScopeSelectComponent extends AbstractSelectComponent<ExemptionScopeSelectRow> implements OnInit {
    ngOnInit() {
    ...
    private compareScopeOptions(a: ExemptionScopeSelectRow, b: ExemptionScopeSelectRow) {
