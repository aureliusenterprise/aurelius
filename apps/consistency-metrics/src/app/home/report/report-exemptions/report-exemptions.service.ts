...
@Injectable()
export class ReportExemptionsService extends BasicStore<ReportExemptionsStoreContext> {
    constructor(
    ...
    get exemptions() {
        return this.select('displayExemptionsPerConcept').pipe(map((exemptions) => flatten(Object.values(exemptions))));
    }
    ...
    private reduceDisplayExemptions(
        ...
        const sharedConceptIds = intersection(Object.keys(violationsPerConcept), Object.keys(exemptionsPerConcept));
