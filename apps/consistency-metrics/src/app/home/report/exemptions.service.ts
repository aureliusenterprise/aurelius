...
import { groupBy, untilDestroyed, indexByProperty } from '@models4insight/utils';
...
export class ExemptionsService extends BasicStore<ExemptionsStoreContext> {
    ...
    createExemption(conceptId: string, comment: string, scope: ExemptionScope, id?: string) {
    ...
    private async handleCreateExemption(conceptId: string, comment: string, scope: ExemptionScope, id: string = null) {
