...
export class ReportService {
    ...
    getMetric(
        ...
        if (project === null || project === undefined) {
            throw new Error('Required parameter project was null or undefined when calling getMetric.');
        }

        // verify required parameter 'branch' is not null or undefined
        if (branch === null || branch === undefined) {
            throw new Error('Required parameter branch was null or undefined when calling getMetric.');
        }

        // verify required parameter 'metric' is not null or undefined
        if (metric === null || metric === undefined) {
            throw new Error('Required parameter metric was null or undefined when calling getMetric.');
        }
        ...
        return this.http.authorize().cache(options.forceUpdate).get<ReportMetric>(path, requestOptions);
    }

    getReport(options: GetOptions = {}): Observable<Report> {
        return this.http.cache(options.forceUpdate).get<Report>(`${this.basePath}/report`);
    }
}
