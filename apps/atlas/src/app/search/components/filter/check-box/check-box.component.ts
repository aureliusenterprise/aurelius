...
import { AppSearchDocument, AppSearchFilterValue } from '@models4insight/atlas/api';
...
export class CheckBoxComponent<T extends AppSearchDocument = AppSearchDocument, K extends keyof T = any>
    implements OnDestroy
{
    ...
    constructor(private readonly filterChoiceService: CheckBoxService<T, K>) {
        ...
        this.control.valueChanges
            ...
            .subscribe((value) => this.filterChoiceService.updateFilterSelection(value));

        this.filterChoiceService.isSelected$
            .pipe(untilDestroyed(this))
            .subscribe((isSelected) => this.control.patchValue(isSelected, { emitEvent: false }));
    }
