...
function updateSystemEditorForm(entityDetails: AtlasEntityWithEXTInformation, form: UntypedFormGroup) {
    ...
    const childSystem = relationshipAttributes.get('childSystem') as UntypedFormArray;

    const collections = relationshipAttributes.get('collections') as UntypedFormArray;

    const parentSystem = relationshipAttributes.get('parentSystem') as UntypedFormArray;
...
export class SystemEditorComponent {
    ...
    get childSystems() {
        return this.editorFormService.form.get('relationshipAttributes.childSystem');
    }
    ...
    get parentSystems() {
        return this.editorFormService.form.get('relationshipAttributes.parentSystem');
    }
