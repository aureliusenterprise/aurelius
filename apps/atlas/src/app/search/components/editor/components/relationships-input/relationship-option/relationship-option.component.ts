...
export class RelationshipOptionComponent {
    ...
    constructor(private readonly searchResultService: AppSearchDocumentService<AtlasEntitySearchObject>) {
    ...
    @Input() set searchResult(searchResult: AppSearchResult<AtlasEntitySearchObject>) {
