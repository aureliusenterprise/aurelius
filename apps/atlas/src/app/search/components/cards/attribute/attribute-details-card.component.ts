...
@Component({
    selector: 'models4insight-attribute-details-card',
    templateUrl: 'attribute-details-card.component.html',
    styleUrls: ['attribute-details-card.component.scss'],
})
export class AttributeDetailsCardComponent implements OnInit {
