...
export class GovernanceQualityListComponent {
    ...
    readonly nonCompliant$: Observable<AppSearchResult<GovernanceQualityListDocument>[]>;
    readonly totalNonCompliant$: Observable<number>;

    constructor(private readonly searchResultsService: AppSearchResultsService<GovernanceQualityListDocument>) {
