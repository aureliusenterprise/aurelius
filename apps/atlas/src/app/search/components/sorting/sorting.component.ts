...
import { AppSearchDocument, AppSearchSort, AppSearchSortKey } from '@models4insight/atlas/api';
...
export class SortingComponent<T extends AppSearchDocument = AppSearchDocument> implements OnInit, OnDestroy {
