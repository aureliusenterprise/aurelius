...
@Injectable()
export class CompliantEntitiesSearchService extends SearchService<GovQualitySearchObject, CompliantEntitySearchObject> {
    constructor(private readonly entityDetailsService: EntityDetailsService) {
        ...
        this.entityDetailsService
            ...
            .subscribe((entityId) => (this.queryObject = this.createQueryObject(entityId)));
    }

    private createQueryObject(entityId: string): AppSearchQuery<GovQualitySearchObject, CompliantEntitySearchObject> {
        return {
            facets: {
...
export class CompliantCardsSearchService extends EntityDetailsCardsSearchService {
    constructor(private readonly searchResultsService: CompliantEntitiesSearchResultsService) {
        super();
