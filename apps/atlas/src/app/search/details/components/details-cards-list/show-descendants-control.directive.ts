import { Directive, ElementRef, Injectable, OnDestroy, Renderer2 } from '@angular/core';
...
export class ShowDescendantsControlDirective extends CheckboxControlValueAccessor implements OnDestroy {
    constructor(
        _renderer: Renderer2,
        ...
        this.registerOnChange(
            (showDescendants: boolean) => (this.showDescendantsService.showDescendants = showDescendants),
        );
    }
