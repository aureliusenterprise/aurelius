...
import { AtlasEntitySearchObject, ElasticSearchResult } from '@models4insight/atlas/api';
...
@Component({
    ...
    providers: [{ provide: AppSearchResultsService, useClass: EntitySearchResultsService }, ElementSearchService],
})
export class ModelExplorerDataGovernanceComponent implements OnDestroy {
    ...
    constructor(
        ...
        ]).pipe(map(([selectionId, searchResult]) => selectionId === searchResult.guid?.raw));
