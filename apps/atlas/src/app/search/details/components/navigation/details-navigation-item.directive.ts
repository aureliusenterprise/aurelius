...
import { Directive, EventEmitter, HostListener, Inject, Injectable, Input, OnDestroy } from '@angular/core';
...
export class DetailsNavigationItemService implements OnDestroy {
    ...
    private async handleScrollToTarget(target: string | HTMLElement) {
        ...
        do {
            ...
            if (scrollInstance.distanceToScroll <= scrollInstance.pageScrollOptions._minScrollDistance) break;
            ...
            uninterrupted &&
            scrollInstance.distanceToScroll > scrollInstance.pageScrollOptions._minScrollDistance
        );
    }
}

@Directive({
    selector: 'models4insightDetailsNavigationItem, [models4insightDetailsNavigationItem]',
})
export class DetailsNavigationItemDirective {
    @Input('models4insightDetailsNavigationItem') target: string | HTMLElement;

    constructor(private readonly detailsNavigationItemService: DetailsNavigationItemService) {}
