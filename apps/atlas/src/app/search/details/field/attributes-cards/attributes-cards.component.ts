...
export class AttributesCardsSearchService extends EntityDetailsCardsSearchService {
    ...
    private createQueryObject(entityId: string): AppSearchQuery<AtlasEntitySearchObject, EntitySearchObject> {
        return {
            query: '',
            facets: {
...
const sortingOptions: string[] = ['name', 'deriveddatadomain', 'deriveddataentity'];
