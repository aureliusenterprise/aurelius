...
import { AppSearchDocument, AppSearchQuery, DataQualitySearchObject } from '@models4insight/atlas/api';
...
> {
    ...
    private createQueryObject(entityId: string): AppSearchQuery<DataQualitySearchObject, DataQualityCardsSearchObject> {
        return {
            query: '',
            facets: {
...
const sortingOptions: string[] = ['name', 'dataqualityruledimension', 'dqscore'];
