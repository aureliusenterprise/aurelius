...
export class ProcessDetailsComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.isLoadingLineageModel$ = this.lineageModelService.select('isRetrievingLineageModel');
        ...
        this.systemCount$ = this.entityDetailsService
            .select(['entityDetails', 'entity', 'relationshipAttributes', 'system', 'length'], { includeFalsy: true })
