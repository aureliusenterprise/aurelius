        ...
        return {
            ...
            filters: {
                all: [
                    ...
                    {
                        [showDescendants ? 'deriveddataentityguid' : 'parentguid']: [entityId],
                    },
                ],
            },
        };
...
@Component({
    selector: 'models4insight-entities-cards',
    templateUrl: 'entities-cards.component.html',
    styleUrls: ['entities-cards.component.scss'],
    providers: [
...
export class EntitiesCardsComponent {
