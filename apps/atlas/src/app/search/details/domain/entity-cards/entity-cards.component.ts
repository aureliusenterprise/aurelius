...
@Injectable()
export class EntityCardsSearchService extends EntityDetailsCardsSearchService {
    constructor(
        ...
        return {
            ...
            filters: {
                all: [
                    ...
                    {
                        [showDescendants ? 'deriveddatadomainguid' : 'parentguid']: [entityId],
                    },
                ],
            },
        };
...
@Component({
    ...
    providers: [
        ...
        EntityCardsSearchService,
        {
            provide: DetailsCardsSearchService,
            useExisting: EntityCardsSearchService,
        },
        { provide: SearchService, useExisting: EntityCardsSearchService },
        ShowDescendantsService,
    ],
})
export class EntityCardsComponent {
    readonly sortingOptions: string[] = sortingOptions;
}
