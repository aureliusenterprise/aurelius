...
export class ResultsComponent {
    ...
    constructor(private readonly searchResultsService: AppSearchResultsService<AtlasEntitySearchObject>) {
        this.data$ = this.searchResultsService.results$;
        this.totalResults$ = this.searchResultsService.totalResults$;
    }

    trackByGuid(_: number, searchResult: AppSearchResult<AtlasEntitySearchObject>) {
