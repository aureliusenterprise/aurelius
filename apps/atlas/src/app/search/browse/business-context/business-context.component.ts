...
import { faChartLine, faCompass, faInfoCircle, faProjectDiagram, faSearch } from '@fortawesome/free-solid-svg-icons';
...
export class BusinessContextComponent {
    ...
    directToConceptual() {
        ...
        this.searchService.filters = {
            all: [{ sourcetype: ['Business'] }, { supertypenames: ['m4i_data_domain'] }],
        };
