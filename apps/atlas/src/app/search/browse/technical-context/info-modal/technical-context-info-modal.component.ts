...
const tableData: TableData[] = [
    ...
    {
        description: 'Represents a set of datasets, e.g. a database which usually contains multiple tables.',
        icon: faProjectDiagram,
        typeName: 'm4i_collection',
    },
    {
        description: 'Represents a set of data fields. The most common example of a dataset is a table.',
        icon: faTable,
