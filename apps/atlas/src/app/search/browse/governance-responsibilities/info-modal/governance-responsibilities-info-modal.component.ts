...
const tableData: TableData[] = [
    {
        description: 'Accountable for the implementation of data management within a data domain.',
        icon: faUser,
    ...
    {
        description: 'Responsible for the implementation of data management controls and related initiatives.',
        icon: faUser,
