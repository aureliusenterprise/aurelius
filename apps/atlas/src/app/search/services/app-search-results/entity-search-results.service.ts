...
import { AtlasEntitySearchObject, AtlasEntitySearchService } from '@models4insight/atlas/api';
...
export class EntitySearchResultsService extends AppSearchResultsService<AtlasEntitySearchObject> {
    constructor(entitySearch: AtlasEntitySearchService, searchService: SearchService<AtlasEntitySearchObject>) {
