...
import { DataQualitySearchObject, DataQualitySearchService } from '@models4insight/atlas/api';
...
export class DataQualitySearchResultsService extends AppSearchResultsService<DataQualitySearchObject> {
    constructor(dataQualitySearch: DataQualitySearchService, searchService: SearchService<DataQualitySearchObject>) {
