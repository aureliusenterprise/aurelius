...
import { AppSearchFacets, AppSearchFields, AtlasEntitySearchObject } from '@models4insight/atlas/api';
...
@Injectable()
export class EntitySearchService extends SearchService<AtlasEntitySearchObject, EntitySearchObject> {
    constructor() {
        super({
            query: '',
            page: {
