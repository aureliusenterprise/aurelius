            ...
            [
                {
                    ...
                    hasPermission: () =>
                        this.branchPermissionService.checkPermission(branch.name, PermissionLevel.CONTRIBUTOR),
                    icon: faEdit,
            ...
            [
                {
                    ...
                    hasPermission: () =>
                        this.branchPermissionService.checkPermission(branch.name, PermissionLevel.OWNER),
                    holdTime: 3,
                    icon: faTimes,
            ...
            [
                {
                    ...
                    hasPermission: () =>
                        this.branchPermissionService.checkPermission(branch.name, PermissionLevel.BUSINESS_USER),
                    icon: faGlobe,
