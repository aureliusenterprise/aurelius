...
export class BranchesTableContextMenuComponent {
            ...
            [
                {
                    ...
                    hasPermission: () => this.checkPermission(branch, PermissionLevel.MODEL_USER),
                    icon: faDownload,
            ...
            [
                {
                    ...
                    hasPermission: () => this.checkPermission(branch, PermissionLevel.BUSINESS_USER),
                    icon: faGlobe,
                ...
                },
                {
                    ...
                    hasPermission: () => this.checkPermission(branch, PermissionLevel.CONTRIBUTOR),
                    icon: faUpload,
                    iconModifier: 'has-text-success',
                    title: 'Upload to',
                },
    ...
    private checkPermission(branch: BranchSummary, permissionLevel: PermissionLevel): Observable<boolean> {
    ...
    private async openConsistencyMetricsInNewTab(branchName: string) {
        ...
        window.open(`/consistency_metrics/home/report?project=${projectId}&branch=${branchId}`, '_blank');
    }
