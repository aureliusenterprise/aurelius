...
export class FileUploadComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.route.queryParamMap
            .pipe(
                switchMap((queryParams) => this.branchesService.getBranchByName(queryParams.get('toBranch'))),
        ...
        this.isCommitingModel$ = this.commitModelService.select('isCommittingModel');
    }
