...
const membersTableConfig: SortableTableShellConfig = {
    ...
    permission: {
        ...
        description: 'The permission level defines which actions the user is allowed to do in the project',
        isStatic: true,
    },
    context_menu: {
        isStatic: true,
...
export class ProjectMemberTableComponent extends AbstractSortableTable implements OnInit {
    ...
    ngOnInit() {
        ...
        this.username$ = this.autheticationService.select(['credentials', 'username']);
    }
