            ...
            [
                {
                    ...
                    hasPermission: () => this.projectPermissionService.checkPermission(PermissionLevel.CONTRIBUTOR),
                    icon: faEdit,
            ...
            [
                {
                    ...
                    hasPermission: () => this.projectPermissionService.checkPermission(PermissionLevel.OWNER),
                    holdTime: 1,
                    icon: faTimes,
