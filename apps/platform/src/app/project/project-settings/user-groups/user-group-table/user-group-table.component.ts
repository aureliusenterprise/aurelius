...
const userGroupTableConfig: SortableTableShellConfig = {
    ...
    permission: {
        ...
        description: 'The level of project access given to members of this user group',
        isStatic: true,
    },
...
export class UserGroupTableComponent extends AbstractSortableTable implements OnInit {
