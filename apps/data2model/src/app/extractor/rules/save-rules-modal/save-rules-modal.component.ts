...
export class SaveRulesModalComponent extends AbstractModalForm<string> implements OnInit {
    ...
    ngOnInit() {
        ...
        this.submission.pipe(untilDestroyed(this)).subscribe(() => this.saveRules());
    }
