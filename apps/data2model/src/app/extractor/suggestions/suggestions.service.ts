...
@Injectable()
export class SuggestionsService extends BasicStore<SuggestionsStoreContext> implements OnDestroy {
    constructor(
    ...
    private async initializeModelBuilder(id: string) {
        const modelBuilder = new ModelBuilder(id, this.extractorService, this.flaskApi, this);
        this.update({
