...
type BaseDefinition = (StaticIdentifier | DynamicIdentifier) & AbstractDefinition;
...
export type ExtractorRule = ElementDefinition | RelationshipDefinition | ViewDefinition;
