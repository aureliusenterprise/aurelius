...
export class UnmappedRelationshipSourceError implements UnmappedRelationshipEndpointError {
    public readonly severity: ValidationErrorSeverity = ValidationErrorSeverity.ERROR;
 ...
 */
export class UnmappedRelationshipTargetError implements UnmappedRelationshipEndpointError {
    public readonly severity: ValidationErrorSeverity = ValidationErrorSeverity.ERROR;
...
export function mappedRelationshipEndpoints(
    ...
    const relationshipsWithUnmappedEndpoints = rules
        .filter((rule: ExtractorRule) => rule.include && rule.type === DefinitionType.RELATION)
