...
def qualities_transform(data: DataFrame) -> DataFrame:
    data["qualifiedName"] = data["dataField"] + "--" + data["id"].astype(str)  # type: ignore
    data["id"] = data["id"].astype(str)  # type: ignore
